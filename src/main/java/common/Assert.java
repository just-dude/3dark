...
public class Assert {
    ...
    public static <T> void notEmpty(T[] argument){
        notEmpty(argument, DEFAULT_NOT_EMPTY_COLLECTION_SIMPLE_EX_MESSAGE);
    }

    public static <T> void notEmpty(T[] argument, String messageFormat, Object... messageArgs) {
        notNull(argument);
